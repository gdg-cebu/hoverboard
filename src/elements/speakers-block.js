...
class SpeakersBlock extends UtilsFunctions(
  ReduxMixin(GestureEventListeners(Element))
) {
  static get template() {
    return `
    ...
    <div class="container">
      ...
      <div class="speakers-wrapper">
        <template is="dom-repeat" items="[[speakers]]" as="speaker">
          <div class="speaker card" on-tap="_openSpeaker" ga-on="click" ga-event-category="speaker" ga-event-action="open details" ga-event-label\$="[[speaker.name]]">
            <div relative="">
...
`;
  ...
  _generateSpeakers(speakers) {
    const filteredSpeakers = this.transformToArray(speakers, 'id')
