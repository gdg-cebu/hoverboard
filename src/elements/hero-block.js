...
class HeroBlock extends Element {
  static get template() {
    return `
    ...
    <div class="hero-block" style\$="color: [[fontColor]]" layout="" start="" vertical="" center-justified="">
      <plastic-image class="hero-image" srcset="[[backgroundImage]]" style\$="background-color: [[backgroundColor]]" sizing="cover" lazy-load="" preload="" fade="" fit=""></plastic-image>
