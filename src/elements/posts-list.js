...
class PostsList extends UtilsFunctions(Element) {
  static get template() {
    return `
    ...
    <template is="dom-repeat" items="[[posts]]" as="post">
      <a href\$="/blog/posts/[[post.id]]/" class="post" layout="" horizontal="">
        <plastic-image class="image" srcset="[[post.image]]" style\$="background-color: [[post.backgroundColor]];" sizing="cover" hidden\$="[[!post.image]]" lazy-load="" preload="" fade=""></plastic-image>
        <div flex="">
